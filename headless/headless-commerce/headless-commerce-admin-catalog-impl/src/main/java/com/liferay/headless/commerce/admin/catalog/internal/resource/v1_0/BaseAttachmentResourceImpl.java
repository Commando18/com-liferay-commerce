...
public abstract class BaseAttachmentResourceImpl implements AttachmentResource {
	...
	public Response deleteAttachment(@NotNull @PathParam("id") Long id)
		throws Exception {
	...
	@Produces({"application/json", "application/xml"})
	@Tags(value = {@Tag(name = "Attachment")})
	public Attachment getAttachment(@NotNull @PathParam("id") Long id)
		throws Exception {
	...
	public Response patchAttachment(
			@NotNull @PathParam("id") Long id, Attachment attachment)
		throws Exception {
