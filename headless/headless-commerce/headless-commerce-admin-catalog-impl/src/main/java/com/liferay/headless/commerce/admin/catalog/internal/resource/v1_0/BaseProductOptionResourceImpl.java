...
public abstract class BaseProductOptionResourceImpl
	...
	public Page<ProductOption> postProductIdProductOptionsPage(
			@NotNull @PathParam("id") Long id, ProductOption[] productOptions)
		throws Exception {
	...
	@Produces({"application/json", "application/xml"})
	@Tags(value = {@Tag(name = "ProductOption")})
	public Response deleteProductOption(@NotNull @PathParam("id") Long id)
		throws Exception {
	...
	@Produces({"application/json", "application/xml"})
	@Tags(value = {@Tag(name = "ProductOption")})
	public ProductOption getProductOption(@NotNull @PathParam("id") Long id)
		throws Exception {
	...
	public Response patchProductOption(
			@NotNull @PathParam("id") Long id, ProductOption productOption)
		throws Exception {
