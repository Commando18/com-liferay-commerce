...
public abstract class BaseRelatedProductResourceImpl
	...
	public Response deleteRelatedProduct(@NotNull @PathParam("id") Long id)
		throws Exception {
	...
	@Produces({"application/json", "application/xml"})
	@Tags(value = {@Tag(name = "RelatedProduct")})
	public RelatedProduct getRelatedProduct(@NotNull @PathParam("id") Long id)
		throws Exception {
	...
	public Page<RelatedProduct> getProductIdRelatedProductsPage(
			@NotNull @PathParam("id") Long id, @QueryParam("type") String type,
	...
	public Page<RelatedProduct>
			getProductByExternalReferenceCodeRelatedProductsPage(
				...
				@QueryParam("type") String type, @Context Pagination pagination)
		throws Exception {
	...
	public RelatedProduct postProductIdRelatedProduct(
			@NotNull @PathParam("id") Long id, RelatedProduct relatedProduct)
		throws Exception {
