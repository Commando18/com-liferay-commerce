...
<h2 class="border-bottom iframe-title pl-3 pr-5 py-2">
...
<div class="container mt-4">
	<div class="mb-5 order-comment">
		<div class="row">
			<div class="col">
				<span class="sticker sticker-lg sticker-user-icon">
					<span class="sticker-overlay">
						<img alt="thumbnail" class="sticker-img" src="https://via.placeholder.com/40" />
					</span>
				</span>
			...
			<div class="align-items-center col col-auto d-flex">
	...
	<div class="form-group">
		<div class="input-group">
			<div class="input-group-item input-group-prepend">
				<input aria-label="Leave a comment..." class="form-control" placeholder="Leave a comment..." type="text" />
			</div>
